        ...
        <div x-data="cartRoot()" x-init="$nextTick(() => init.call($data))" x-ref="root" class="space-y-6">
            ...
            @if (count($cartItems) === 0)
                <div class="bg-white text-center p-10 rounded-lg shadow-md">
                    <p class="text-xl text-gray-600 mb-4">Belum ada produk ditambahkan di keranjang.</p>
                    <a href="{{ route('shop') }}" class="inline-block mt-2 px-6 py-2 bg-[#414833] text-white rounded hover:bg-[#00695C] transition">
                        Lihat Produk
                    </a>
                </div>
            @else
