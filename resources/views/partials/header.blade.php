...
<header x-data="{ menuOpen: false, searchOpen: false, profileOpen: false }" class="bg-[#414833] text-white py-2 relative">
    ...
    <form action="{{ route('shop') }}" method="GET"
        ...
        <input type="text" name="q" value="{{ request('q') }}" placeholder="Search for perfume..." class="w-full bg-transparent outline-none">
        <button type="submit" class="ml-4 text-sm text-black-600 hover:underline"></button>
